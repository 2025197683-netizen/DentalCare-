  ...
  if (typeof emailjs !== "undefined") {
    ...
    if (contactForm) {
      ...
      contactForm.addEventListener("submit", function (e) {
        ...
        emailjs
          .sendForm("service_0u7fucw", "template_hlcrbhu", this)
          .then(() => {
            if (formStatus) {
...
function detectGenderByName(name) {
  const female = ["aisyah","amira","siti","nur","farah","ain","alya","hannah"];
  const male = ["danial","adam","amir","hakim","faiz","irfan","akasyah"];
